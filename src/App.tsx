  ...
  return (
    <div className="relative z-10 w-[760px] h-[560px] flex flex-col">
      ...
      <main className="flex-1 min-h-0 flex gap-2 p-2">
        <div style={{ flexBasis: '61.8%', flexGrow: 0, flexShrink: 1 }} className="min-w-0 h-full">
          <WordPanel />
        </div>
        <div style={{ flexBasis: '38.2%', flexGrow: 0, flexShrink: 1 }} className="min-w-0 h-full flex flex-col gap-2">
