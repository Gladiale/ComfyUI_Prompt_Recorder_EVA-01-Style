    ...
    <section className="flex flex-col h-full">
      ...
      <header className="flex items-center justify-between pb-2 mb-2 border-b border-eva-line">
        <button
          ...
          title="時計ロードマップを開く"
          className="font-cinzel-deco tracking-[0.2em] text-[13px] text-[#f3c6ff] hover:text-eva-green glow-text whitespace-nowrap cursor-pointer transition-all select-none active:scale-95"
        >
          🕆WORDS🕆
        </button>
